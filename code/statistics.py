...
prepared_artists_from_lastfm_file_path = os.path.join(
    dir, "../data/prepared/artists.txt")
...
artists_last_fm = helpers.file_len(prepared_artists_from_lastfm_file_path)
...
print "  Cleaned Artists from Last FM Charts: \033[0;36m{0}\033[0;0m".format(artists_last_fm)
